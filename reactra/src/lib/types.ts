...
export interface Team {
  ...
  definitionTitle?: string; // denormalized copy, so the team page can show it without an extra read
  definitionDescription?: string; // denormalized copy, so the team page can show it without an extra read
  createdAt: number;
}
